...
class AnswerController {
  async addAnswer(req, res) {
    try {
      ...
      if (isEmptyAnswer.length > 0) throw new InvariantError('REQUIRED_QUESTION_EMPTY_ANSWER', { question: isEmptyAnswer[0].question });
      ...
      if (checkAnswerByOpt.length > 0) throw new InvariantError('ANSWER_NOT_MATCH_OPTION_VALUE', { question: checkAnswerByOpt[0].question });
